...
function HomePage() {
  ...
  const computedIsFeed = isFeed && !activeTag
  const filters = { limit: DEFAULT_LIMIT, offset, tag: activeTag, feed: computedIsFeed }
              ...
              <ul className="nav nav-pills outline-active">
                ...
                <li className="nav-item">
                  <button
                    ...
                    className={classNames('nav-link', { active: computedIsFeed })}
                  >
                    Your Feed
                  </button>
                </li>
                <li className="nav-item">
                  <button
                    onClick={() => {
                      setActiveTag(null), setIsFeed(false)
                    }}
                    type="button"
